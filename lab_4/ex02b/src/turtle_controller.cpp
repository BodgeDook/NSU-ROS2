...
public:
  ...
  : Node("turtle_controller"), tf_buffer_(this->get_clock()), tf_listener_(tf_buffer_)
  {
    ...
    target_pub_ = this->create_publisher<turtle_multi_target::msg::CurrentTarget>("/current_target", 10);
...
private:
  ...
  void control_loop()
  {
    ...
    auto target_msg = turtle_multi_target::msg::CurrentTarget();
  ...
  rclcpp::Publisher<turtle_multi_target::msg::CurrentTarget>::SharedPtr target_pub_;
