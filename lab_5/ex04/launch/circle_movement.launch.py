...
def generate_launch_description():
    pkg_name = 'robot_circle_movement'
    pkg_robot_gazebo = get_package_share_directory(pkg_name)
    ...
    return LaunchDescription([
        ...
        TimerAction(
            ...
            actions=[
                Node(
                    package=pkg_name, # robot_circle_movement
                    executable='circle_movement_node', 
                    name='circle_movement_controller',
                    output='screen',
                    parameters=[{'use_sim_time': True}]
                ),
            ]
